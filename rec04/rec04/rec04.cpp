...
//  rec04
//
//  Created by David Zhang on 2/18/22.
//
...
public:
    ...
    void movesInWith(Person& newRoomate){
        if(&newRoomate == this || roomie || newRoomate.roomie){
            cerr << "ERROR" << endl;
            return;
        }
...
int main(int argc, const char * argv[]) {
    ...
    *pDyn = 17;
    ...
    //Does a *variable value go to heap???
    ...
    //Double deleting causes an error
    short* pShrt = new short(5);
    delete pShrt;
    //delete pShrt;
    
    //Delete can only be used w/ heap and not the stack
    ...
    Person joeBob("Joe Bob"), billyJane("Billy Jane"), tomNook("Tom Nook");

    tomNook.movesInWith(tomNook);
